...
class AzureGenderModel(Model):
    def __init__(self, bounds, src_img_gender, suffix, channel_axis=2):
        super(AzureGenderModel, self).__init__(bounds=bounds, channel_axis=channel_axis)
        ...
        self.src_img_gender = src_img_gender
        self.suffix = suffix
    ...
    def forward(self, inputs):
        ...
        for _i in range(inputs.shape[0]):
            ...
            try:
                ...
                qry_attribute = qry_faces[0].face_attributes.gender
                flag = (qry_attribute == self.src_img_gender)
